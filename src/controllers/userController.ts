...
import { editPasswordById, editUserById } from "../services/userService";
...
const editPassword = async (req: Request & { user?: string }, res: Response) => {
    try {
